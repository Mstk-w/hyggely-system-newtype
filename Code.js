...
function getDefaultProducts() {
  return [
    {id: 'PRD001', name: 'プレミアムカンパーニュ', price: 1100, order: 1, columnIndex: 6},
    {id: 'PRD002', name: 'プレミアムカンパーニュ 1/2', price: 650, order: 2, columnIndex: 7},
    {id: 'PRD003', name: 'レーズン&クルミ', price: 1300, order: 3, columnIndex: 8},
    {id: 'PRD004', name: 'レーズン&クルミ 1/2', price: 650, order: 4, columnIndex: 9},
    {id: 'PRD005', name: 'いちじく&クルミ', price: 450, order: 5, columnIndex: 10},
    {id: 'PRD006', name: '4種のMIXナッツ', price: 450, order: 6, columnIndex: 11},
    {id: 'PRD007', name: 'MIXドライフルーツ', price: 450, order: 7, columnIndex: 12},
    {id: 'PRD008', name: 'アールグレイ', price: 400, order: 8, columnIndex: 13},
    {id: 'PRD009', name: 'チョコレート', price: 500, order: 9, columnIndex: 14},
    {id: 'PRD010', name: 'チーズ', price: 500, order: 10, columnIndex: 15},
    {id: 'PRD011', name: 'ひまわりの種', price: 450, order: 11, columnIndex: 16},
    {id: 'PRD012', name: 'デーツ', price: 450, order: 12, columnIndex: 17},
    {id: 'PRD013', name: 'カレーパン', price: 500, order: 13, columnIndex: 18},
    {id: 'PRD014', name: 'バターロール', price: 270, order: 14, columnIndex: 19},
    {id: 'PRD015', name: 'ショコラロール', price: 320, order: 15, columnIndex: 20},
    {id: 'PRD016', name: '自家製クリームパン', price: 400, order: 16, columnIndex: 21},
    {id: 'PRD017', name: '自家製あんバター', price: 430, order: 17, columnIndex: 22},
    {id: 'PRD018', name: '抹茶&ホワイトチョコ', price: 450, order: 18, columnIndex: 23},
    {id: 'PRD019', name: '黒ごまパン', price: 220, order: 19, columnIndex: 24},
    {id: 'PRD020', name: 'レーズンジャムとクリームチーズのパン', price: 400, order: 20, columnIndex: 25},
    {id: 'PRD021', name: 'ピーナッツクリームパン', price: 400, order: 21, columnIndex: 26},
    {id: 'PRD022', name: 'あん食パン', price: 450, order: 22, columnIndex: 27},
    {id: 'PRD023', name: 'コーンパン', price: 450, order: 23, columnIndex: 28},
    {id: 'PRD024', name: 'レモンとクリームチーズのミニ食パン', price: 500, order: 24, columnIndex: 29},
    {id: 'PRD025', name: 'ピザ マルゲリータ', price: 1200, order: 25, columnIndex: 30},
    {id: 'PRD026', name: 'ピタパンサンド', price: 900, order: 26, columnIndex: 31},
    {id: 'PRD027', name: 'フォカッチャ', price: 340, order: 27, columnIndex: 32}
  ];
}
